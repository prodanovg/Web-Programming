...
//        List<SavedBooking> bookingsToSend = eventService.searchSavedBookings(queryString);
//
...
//
//        String eventName = req.getParameter("radio1");
//        String numOfTickets = req.getParameter("numberOfTickets");
//
